...
test_that("Output get_filter function (Within)", {
  expect_equal(
    c(
      mean(get_filter(outcome = "AllocOut", treatment = "AllocStr", data = data1)[["results"]]$SS, na.rm = T),
...
test_that("Output get_filter function (Between)", {
  expect_equal(
    c(
      mean(get_filter(outcome = "Coop", treatment = "IdentificationMANIPULATION", data = data2)[["results"]]$SS, na.rm = T),
...
test_that("Output point function (config I; lower)", {
  expect_equal(
    as.numeric(get_point(outcome = "Coop", treatment = "IdentificationMANIPULATION", exp = c("age == 50", "gender == 1"), data = data2)[["lower"]]),
...
test_that("Output point function (config I; point)", {
  expect_equal(
    as.numeric(get_point(outcome = "Coop", treatment = "IdentificationMANIPULATION", exp = c("age == 50", "gender == 1"), data = data2)[["point"]]),
...
test_that("Output point function (config I; upper)", {
  expect_equal(
    as.numeric(get_point(outcome = "Coop", treatment = "IdentificationMANIPULATION", exp = c("age == 50", "gender == 1"), data = data2)[["upper"]]),
    c(342, 0.05190539, -0.01401989, -0.22736255, 0.19932276)
  )
})
...
test_that("Output point function (config II; no whitespace; lower)", {
  expect_equal(
    as.numeric(get_point(outcome = "Coop", treatment = "IdentificationMANIPULATION", exp = c("age==20", "gender== 2"), data = data2)[["lower"]]),
...
test_that("Output point function (config II; no whitespace; point)", {
  expect_equal(
    as.numeric(get_point(outcome = "Coop", treatment = "IdentificationMANIPULATION", exp = c("age==20", "gender== 2"), data = data2)[["point"]]),
...
test_that("Output point function (config II; no whitespace; upper)", {
  expect_equal(
    as.numeric(get_point(outcome = "Coop", treatment = "IdentificationMANIPULATION", exp = c("age==20", "gender== 2"), data = data2)[["upper"]]),
